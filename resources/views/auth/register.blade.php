    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                            ...
                            <div class="text-center mb-11">
                                ...
                                <!--end::Title-->
                                <!--begin::Subtitle-->
                                <div class="text-gray-500 fw-semibold fs-6">Dobro došli u E-Apartmane</div>
                                <!--end::Subtitle=-->
                            </div>
                            <!--begin::Heading-->
                            <!--begin::Login options-->
                            ...
                            <div class="fv-row mb-8">
                                <input id="name" type="text"
                                    ...
                                    placeholder="Unseite ime korisnika">
                            ...
                            <div class="fv-row mb-8">
                                <input id="surname" type="text"
                                    ...
                                    placeholder="Unseite prezime korisnika">
                            ...
                            <div class="fv-row mb-8">
                                <input id="email" type="email"
                                    ...
                                    placeholder="Unseite email korisnika">
                            ...
                            <div class="fv-row mb-8" data-kt-password-meter="true">
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="position-relative mb-3">
                                        <input id="password" type="password"
                                            ...
                                            required autocomplete="new-password" placeholder="Unseite šifru korisnika">
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Hint-->
                                <div class="text-muted">Koristite 8 karaktera sa kombinacijom velikih i malih slova,
                                    brojeva i specijalnih karaktera.</div>
                                <!--end::Hint-->
                            </div>
                            {{-- PASSWORD --}}
                            <!--end::Input group=-->
                            ...
                            {{-- TIP KORISNIKA --}}
                            <div class="fv-row mb-8">
                                <select id="role" class="form-select" data-control="select2"
                                    data-placeholder="Odaberite nivo pristupa"
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                style="background-image: url(assets/media/misc/budva.jpg);">
                <!--begin::Content-->
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    ...
                    <!--begin::Image-->
                    <a href="/kalendar">
                        <img class="d-none d-lg-block mx-auto w-200px w-md-50 w-xl-350px mb-1000 mb-lg-2000"
                            src="assets/media/logos/ELOGO.png" alt="" />
                    </a>
                    <!--end::Image-->
                    <!--begin::Title-->
