...
<body id="kt_app_body" data-kt-app-page-loading-enabled="true" data-kt-app-layout="dark-sidebar"
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div id="kt_app_header" class="app-header" data-kt-sticky="true"
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    {{-- <div class="col-6 d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <h1 style="color: white;">E-Apartmani</h1>
                    </div> --}}
                    <!--end::Mobile logo-->
                        ...
                        <div class="app-navbar flex-shrink-0">
                            ...
                            <div class="app-navbar-item ms-1 ms-md-4">
                                ...
                                <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" id="kt_menu_item_wow">
                                    @if ($user->unreadNotifications->count() !== 0)
                                        <span class="bullet bullet-dot bg-success translate-bottom animation-blink"></span>
                                    @endif
                                    <i class="ki-duotone ki-notification-status fs-2" style="position: relative;">
                                        <span class="path1"></span>
                                        <span class="path2"></span>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                    ...
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                        ...
                                        <!--begin::Title-->
                                        <h3 class="text-white fw-semibold px-9 mt-10 mb-6">Notifikacije
                                            <span
                                        ...
                                        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active"
                                                    data-bs-toggle="tab" aria-selected="true" href="#kt_topbar_notifications_3">Nepročitane notifikacije</a>
                                            </li>
                                        </ul>
                                        <!--end::Tabs-->
                                    </div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade show active" id="kt_topbar_notifications_3" role="tabpanel">
                                            ...
                                            <div class="scroll-y mh-325px my-5 px-8">
                                                <!--begin::Item-->
                                                <div class="d-flex flex-stack flex-column py-4">
                                                    <!--begin::Section-->
                                                    @forelse ($user->unreadNotifications as $key => $notification)
                                                        @if (session('user')->id === $notification->notifiable_id)
                                                            <div class="d-flex flex-stack flex-column mb-5">
                                                                <div class="d-flex align-items-center me-2">
                                                                    <!--begin::Code-->
                                                                    {{-- <span class="w-70px badge badge-light-success me-4"> Info</span> --}}
                                                                    <!--end::Code-->
                                                                    <!--begin::Title-->
                                                                    <div class="col-12">
                                                                        <a href="{{ $notification->data['notificationPath'] }}" class="text-gray-800 text-hover-primary fw-semibold">{{ $notification->data['message'] }}</a><br>
                                                                        {{-- <a class="link-opacity-25-hover" href={{ $notification->data['notificationPath'] }}>Rezervacije</a> --}}
                                                                    </div>
                                                                    <!--end::Title-->
                                                                    <div class="col-1">
                                                    ...
                                                    @empty
                                                        <div class="d-flex align-items-center me-2">
                                                            <a class="text-gray-800 text-hover-primary fw-semibold">Nema notifikacija</a>
                                                        </div>
                                                    @endforelse
                                                </div>
                                            ...
                                            <div class="py-3 text-center border-top">
                                                <a href="/notifikacije"
                                                    class="btn btn-color-gray-600 btn-active-color-primary">Sve notifikacije
                            ...
                            <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-300px"
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">{{ session('user')->name . ' ' . session('user')->surname }}
                                                        @if (session('user')->role == 'SUPERADMIN')
                                                            {{-- <li class="text-center mt-1"><strong>Super administrator</strong></li> --}}
                                                            <span class="badge badge-light-danger fw-bold fs-8 px-2 py-1 ms-2">SA</span>
                                                        @elseif (session('user')->role == 'ADMIN')
                                                            {{-- <li class="text-center mt-1"><strong>Administrator</strong></li> --}}
                                                            <span class="badge badge-light-warning fw-bold fs-8 px-2 py-1 ms-2">A</span>
                                                        @else
                                                            {{-- <li class="text-center mt-1"><strong>Korisnik</strong></li> --}}
                                                            <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">K</span>
                                                        @endif
                                                </div>
                                                <a href="#"
                                    ...
                                    @if (session('user')->role == 'SUPERADMIN')
                                        <div class="menu-item px-5">
                                            <a href="/register" class="menu-link px-5">
                                                ...
                                                <span class="menu-title">Registrujte novog korisnika</span>
                                            </a>
                                        </div>
                                    @endif
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <a href="/korisnicka-podesavanja" class="menu-link px-5">
                                            <i class="ki-duotone ki-setting-2 fs-2x">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                            </i>&nbsp;&nbsp;&nbsp;&nbsp;
                                            <span class="menu-title">Korisnička podešavanja</span>
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu separator-->
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
                    ...
                    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
                        ...
                        <a href="/kalendar"
                            ...
                            <i class="fa-brands fa-squarespace fs-2tx" style="color: #4eb3ac; margin-left: -45px"></i>
                            <span id="sidebar_text" class="fs-2">&nbsp;&nbsp;E-Apartmani</span>
                        </a>
                        <!--end::Logo image-->
                        <!--begin::Sidebar toggle-->
                        <div id="kt_app_sidebar_toggle" class="app-sidebar-toggle btn btn-icon btn-shadow btn-sm btn-color-muted btn-active-color-primary h-30px w-30px position-absolute top-50 start-100 translate-middle rotate" data-kt-toggle="true" data-kt-toggle-state="active" data-kt-toggle-target="body" data-kt-toggle-name="app-sidebar-minimize">
                            <i class="ki-duotone ki-burger-menu-3 fs-3">
                            <span class="path1"></span>
                            <span class="path2"></span>
                            <span class="path3"></span>
                            <span class="path4"></span>
                        ...
                        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
                            ...
                            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true"
                                ...
                                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6"
                                    ...
                                    {{-- KALENDAR --}}
                                    <div class="menu-item">
                                        <a class="menu-link" href="/kalendar">
                                    ...
                                    {{-- REZERVACIJE --}}
                                    <div class="menu-item">
                                        <a class="menu-link" href="/rezervacije">
                                            <span class="menu-icon">
                                                <i class="fa fa-registered fs-1"></i>
                                            </span>
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <span class="menu-link">
                                            ...
                                            <span class="menu-title">Apartmani</span>
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            ...
                                            <div class="menu-item">
                                                <a class="menu-link" href="/lista-apartmana">
                                                    ...
                                                    <span class="menu-title">Lista apartmana</span>
                                                </a>
                                            </div>
                                            {{-- LISTA APARTMANA --}}
                                    ...
                                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                        ...
                                        <div class="menu-sub menu-sub-accordion">
                                            {{-- LISTA PRIHODA --}}
                                            <div class="menu-item">
                                                <a class="menu-link" href="/lista-prihoda">
                                                    <span class="menu-bullet">
                                                        <span class="bullet bullet-dot"></span>
                                                    </span>
                                    ...
                                    {{-- PARKING --}}
                                    <div class="menu-item">
                                        <a class="menu-link" href="/parking">
                                            <span class="menu-icon">
                                                <i class="fa fa-parking fs-1"></i>
                                            </span>
                                    ...
                                    @if (session('user')->role == 'SUPERADMIN')
                                        ...
                                        <div class="menu-item pt-5">
                                            ...
                                            <div class="menu-content">
                                                <span class="menu-heading fw-bold text-uppercase fs-7">Super
                                                    administrator</span>
                                            </div>
                                            <!--end:Menu content-->
                                        </div>
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link-->
                                            <a class="menu-link" href="/administracija-korisnika" target="_blank">
                                                <span class="menu-icon">
                                                    <i class="fa fa-user-circle fs-1"></i>
                                                </span>
                                                <span class="menu-title">Administracija korisnika</span>
                                            </a>
                                            <!--end:Menu link-->
                                        </div>
                                        {{-- SUPERADMIN PART --}}
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var sidebarText = document.getElementById('sidebar_text');
